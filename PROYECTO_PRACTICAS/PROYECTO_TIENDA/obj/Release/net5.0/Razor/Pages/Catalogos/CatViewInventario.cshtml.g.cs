#pragma checksum "D:\SistemaTiendaRopa\PROYECTO_TIENDA\Pages\Catalogos\CatViewInventario.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f065c45a38cb623e47a58bb522844a689f8251aa"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f065c45a38cb623e47a58bb522844a689f8251aa", @"/Pages/Catalogos/CatViewInventario.cshtml")]
    ...
    const CargarDatos = async () => {
        ...
        TxtBusquedaProducto.onchange = (ev) => {
            ...
            const ProductosFiltrados = Producto.filter(x => x.nombreProducto.in");
            WriteLiteral(@"cludes(parametro));
    ...
    //AGREDAR PRODUCTO DE MODAL A INPUT
        ...
        window.onload = async () => {
            BtnSave.onclick = async () => {
                ...
                for (var prop in ObjInst) {
                    if (ObjInst[prop] == """") {
                        flag = false;
                        alert(""la propiedad """);
            WriteLiteral(@" + prop + "" es requerida"");
                        break;
                    }
                }
            ...
            BtnCerrarProducto.onclick = () => {
                ModalF");
            WriteLiteral(@"unction(ModalProducto);
            }
        }
</script>
<div></div>
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f065c45a38cb623e47a58bb522844a689f8251aa8558", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f065c45a38cb623e47a58bb522844a689f8251aa9869", async() => {
